...
for y, e in enumerate((entity, child)):
    for i, name in enumerate(('x', 'y', 'z')):
        slider = Slider(-1, 1, default=getattr(e, name), text=name, dynamic=True,
                        position=(.1, .4 - (i * spacing) - y * .5), parent=ui_parent)
        ...
        name = 'rotation_' + name
        slider = Slider(0, 360, default=getattr(e, name), text=name, dynamic=True,
                        position=(.1, .4 - (i * spacing) - (spacing * 3) - y * .5), parent=ui_parent)
        ...
        slider = Slider(.1, 3, default=getattr(e, name), text=name, dynamic=True,
                        position=(.1, .4 - (i * spacing) - (spacing * 6) - y * .5), parent=ui_parent)
